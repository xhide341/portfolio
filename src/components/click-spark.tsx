...
const ClickSpark: React.FC<ClickSparkProps> = ({
    ...
    useEffect(() => {
        ...
        const resizeCanvas = () => {
            const width = parent.clientWidth; // Use parent element's width
            const height = parent.clientHeight; // Use parent element's height
            console.log("Parent dimensions:", width, height); // Debugging line
            if (canvas.width !== width || canvas.height !== height) {
                canvas.width = width;
                canvas.height = height;
                console.log("Canvas resized to:", width, height); // Debugging line
            }
        };
