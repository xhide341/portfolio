const PrismaIcon = ({ width = "20px", height = "20px" }: { width?: string; height?: string }) => {
  return (
    <div className="tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 100 100">
